...
def sortActivities(folder):
	ground_truth='/media/bsb/666/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/features_binary_svm_format'
	#dataset = '/media/bsb/666/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/segments_svm_format/fold_{0}'.format(fold)
        dataset='/media/bsb/666/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/dataset/fold_{0}'.format(fold)
...
if __name__ == '__main__':
	...
	for fold in folds:	
		...
		s='/media/bsb/666/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/features_binary_svm_format'
		test_file = '/media/bsb/666/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/segments_svm_format/fold{0}'.format(fold)
		...
		for j in folds:
			if j == fold:
				continue
			train_file = '/media/bsb/666/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/segments_svm_format/fold{0}'.format(j)
